$(document).ready(function () {
    ...
    $(window).resize(function() {
        ...
        $('#navbar-li-ul1').css("left", `${newWindowWidth * 0.18}px`);  // 10% của độ rộng
        $('#navbar-li-ul2').css("left", `${newWindowWidth * 0.243}px`); // 15% của độ rộng
        $('#navbar-li-ul3').css("left", `${newWindowWidth * 0.457}px`); // 25% của độ rộng
